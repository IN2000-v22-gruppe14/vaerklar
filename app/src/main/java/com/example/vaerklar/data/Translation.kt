...
val clothingItemNameToDrawable = hashMapOf(
    ...
    "genser2" to R.drawable.sweater2,
    ...
    "ullgenser2" to R.drawable.wool2,
    ...
    "vindjakke2" to R.drawable.windjacket2,
